    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stage', models.CharField(choices=[('brief', '📥 Brief Intake'), ('qualified', '✅ Qualified'), ('shortlist', '🎤 Artist Shortlist'), ('proposal_draft', '📄 Proposal Draft'), ('proposal_sent', '📧 Proposal Sent'), ('negotiation', '💬 Negotiation'), ('contract_prep', '📝 Contract Prep'), ('contract_sent', '✍️ Contract Sent'), ('won', '🎯 Won'), ('executing', '🚀 Executing'), ('completed', '✨ Completed'), ('closed_lost', '❌ Lost')], db_index=True, default='brief', help_text='Current pipeline stage', max_length=20)),
