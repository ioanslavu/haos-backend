...
from .views import (
    ...
    ContactPersonViewSet, EntityScoreViewSet, EntityScoreHistoryViewSet
)
...
router.register(r'entity-scores', EntityScoreViewSet)
router.register(r'entity-score-history', EntityScoreHistoryViewSet)
